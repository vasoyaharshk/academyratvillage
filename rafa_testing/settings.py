...
TOUCHSCREEN_PORT = (
    "/dev/input/by-id/usb-Touch__KiT_Touch_Computer_INC.-event-if00"  # <-- TO CHANGE
)
...
NOMICEDOOR1 = (
    3  # if area_doors1 > NOMICEDOOR1 animal can not enter    # <-- TO CHANGE Harsh-Done
)
...
LONGER_TIME_TO_ENTER = (
    []
)  # animals with longer inter session times      # <-- TO CHANGE
