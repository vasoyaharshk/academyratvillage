...
class Video(Process):
    def __init__(self, port='0', cam_number=0, name_video=None, path=None, width=None, height=None, fps=None,
                 ...
                 cage_zone=None, doors1_zone=None, doors2_zone=None, floor1_zone=None, floor2_zone=None,
    ...
    def do_tracking_position(self):
        if self.tracking_position:
            ...
            frame_mouse = cv2.bitwise_and(gray_frame, mask_mouse)
            frame_mouse = cv2.bitwise_or(frame_mouse, mask_mouse2)
    ...
    def add_info_tracking_position(self):
        if self.tracking_position:
            try:
                ...
                if self.led_on:
                    cv2.circle(self.frame, (self.cx, self.cy + 100), 5, (255, 255, 0), -1)
            except:
                pass
