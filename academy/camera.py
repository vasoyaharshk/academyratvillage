...
class Video(Process):
    ...
    def do_tracking_out(self):
        ...
        cage_greyscale_frame1 = cv2.cvtColor(self.frame[zcymin1:zcymax1, zcxmin1:zcxmax1], cv2.COLOR_BGR2GRAY)
    ...
    def add_info_tracking_out(self):
        try:
            ...
            cv2.rectangle(self.frame, (zcxmin1, zcymin1), (zcxmax1, zcymax1), (0, 255, 0), 2)
