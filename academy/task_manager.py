        ...
        if self.df['TRIAL'].iloc[-1] > 1:
            ...
            if weight:
                utils.subjects.add_new_item({'task': task,
                                             ...
                                             'block_stim_correct_count_1': block_stim_correct_count_1,
                                             'block_stim_valid_count_1': block_stim_valid_count_1,
                                             'block_stim_accuracy_1': block_stim_accuracy_1,
                                             'block_stim_correct_count_2': block_stim_correct_count_2,
                                             'block_stim_valid_count_2': block_stim_valid_count_2,
                                             'block_stim_accuracy_2': block_stim_accuracy_2,
                                             ...
                                             'last_two_stim': last_two_stim,
                                             'unrewarded_list': unrewarded_list,
                                             'pr_carry_tone': pr_carry_tone,
                                             'pr_carry_pending': pr_carry_pending,
                                             'consecutive_good_blocks': consecutive_good_blocks,
                                             }, item=self.subject)
