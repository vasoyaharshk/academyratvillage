...
CAM1_THRESHOLD = 0
CAM1_CAGE_ZONE1 = [112, 145, 85, 255]       # <-- TO CHANGE left, right, top, down
CAM1_CAGE_ZONE2 = [80, 175, 255, 300]     # <-- TO CHANGE left, right, top, down
CAM1_DOORS1_ZONE = [175, 465, 265, 310]   # <-- TO CHANGE left, right, top, down Harsh done
CAM1_DOORS2_ZONE = [465, 620, 268, 305]   # <-- TO CHANGE left, right, top, down
