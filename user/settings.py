...
XINPUT = 'xinput map-to-output "Touch__KiT Touch  Computer INC." DP-1-2-1'   # <-- TO CHANGE
...
CAM1_DOORS1_ZONE = [233, 470, 258, 295]   # <-- TO CHANGE left, right, top, down Harsh done
CAM1_DOORS2_ZONE = [470, 590, 265, 290]   # <-- TO CHANGE left, right, top, down
