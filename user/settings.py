...
CAM1_THRESHOLD = 0
CAM1_CAGE_ZONE1 = [112, 162, 85, 255]       # <-- TO CHANGE left, right, top, down
CAM1_CAGE_ZONE2 = [105, 200, 255, 300]     # <-- TO CHANGE left, right, top, down
CAM1_DOORS1_ZONE = [200, 490, 265, 310]   # <-- TO CHANGE left, right, top, down Harsh done
