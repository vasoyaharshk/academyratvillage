...
CAM1_DOORS1_ZONE = [175, 450, 273, 320]   # <-- TO CHANGE left, right, top, down Harsh done
CAM1_DOORS2_ZONE = [450, 610, 275, 310]   # <-- TO CHANGE left, right, top, down
