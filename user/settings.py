...
NOMICECAGE = 50000  # if area_cage > NOMICECAGE animal can not enter        # <-- TO CHANGE Harsh-Done
...
THRESHOLD_NIGHT_CAGE1 = 45                                                # <-- TO CHANGE Harsh-Done                                               # <-- TO CHANGE Harsh-Done
THRESHOLD_NIGHT_CAGE2 = 60                                                # <-- TO CHANGE Harsh-Done                                             # <-- TO CHANGE Harsh-Done.
...
CAM1_CAGE_ZONE2 = [60, 235, 195, 300]     # <-- TO CHANGE left, right, top, down
CAM1_DOORS1_ZONE = [235, 463, 260, 295]   # <-- TO CHANGE left, right, top, down Harsh done
...
DEFAULT_TRIALS_MAX = 500
DEFAULT_DURATION_MAX = 36000  # seconds
DEFAULT_TRIALS_TIRED = 500
