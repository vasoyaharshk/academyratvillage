...
def function41():  # When the correct answer is on left
    ...
    left_images = []
    try:
        image_folder = f'/home/ratvillage03/academy/stimuli/webers_law/4_webers_law/{current_condition}'
...
def function51():  # When the blue jar is on left
    ...
    try:
        # Get all the images based on the stages
        if stage == 1:
            image_folder = '/home/ratvillage03/academy/stimuli/urn_training/0_extra_training/1_1_indication'
            left_images = [f for f in os.listdir(image_folder) if
                           os.path.isfile(os.path.join(image_folder, f)) and 'left' in f.lower()]
        elif stage == 2:
            image_folder = '/home/ratvillage03/academy/stimuli/urn_training/0_extra_training/1_2_discrimination_1'
            left_images = [f for f in os.listdir(image_folder) if
                           os.path.isfile(os.path.join(image_folder, f)) and
                           ('left' in f.lower() and 'both' in f.lower())]
        elif stage == 3:
            image_folder = '/home/ratvillage03/academy/stimuli/urn_training/0_extra_training/1_3_discrimination_2'
            left_images = [f for f in os.listdir(image_folder) if
                           os.path.isfile(os.path.join(image_folder, f)) and
                           ('left' in f.lower() and 'both' in f.lower())]
        elif stage == 4:
            image_folder = '/home/ratvillage03/academy/stimuli/urn_training/0_extra_training/1_4_discrimination_3'
            left_images = [f for f in os.listdir(image_folder) if
                           os.path.isfile(os.path.join(image_folder, f)) and
                           ('left' in f.lower() and 'both' in f.lower())]
        elif stage == 5:
            image_folder = '/home/ratvillage03/academy/stimuli/urn_training/0_extra_training/1_5_discrimination_4'
            left_images = [f for f in os.listdir(image_folder) if
                           os.path.isfile(os.path.join(image_folder, f)) and
                           ('left' in f.lower() and 'both' in f.lower())]
...
def function57(): #For A_TouchTeaching_incorrect, punish doenst display image
    soundStream.play(soundVec3)
...
#         # Get all the images based on the stages
#         if substage == 0:
#             image_folder = '/home/ratvillage03/academy/stimuli/turtle_style/6_turtle_style/0_pre_training'
#             left_images = [f for f in os.listdir(image_folder) if
#                            os.path.isfile(os.path.join(image_folder, f)) and
#                            ('left' in f.lower() and 'both' in f.lower())]
#         elif substage == 1:
#             image_folder = '/home/ratvillage03/academy/stimuli/turtle_style/6_turtle_style/1_training'
#             left_images = [f for f in os.listdir(image_folder) if
#                            os.path.isfile(os.path.join(image_folder, f)) and
#                            ('left' in f.lower() and 'both' in f.lower())]
#         elif substage == 2:
#             image_folder = '/home/ratvillage03/academy/stimuli/turtle_style/6_turtle_style/2_training'
#             left_images = [f for f in os.listdir(image_folder) if
#                            os.path.isfile(os.path.join(image_folder, f)) and
#                            ('left' in f.lower() and 'both' in f.lower())]
#         elif substage == 3:
#             image_folder = '/home/ratvillage03/academy/stimuli/turtle_style/6_turtle_style/3_training'
#             left_images = [f for f in os.listdir(image_folder) if
#                            os.path.isfile(os.path.join(image_folder, f)) and
#                            ('left' in f.lower() and 'both' in f.lower())]
#
...
def function81():  # When the correct answer is on left
    ...
    left_images = []
    try:
        image_folder = f'/home/ratvillage03/academy/stimuli/webers_law/4_webers_law_post/{current_condition}'
        left_images = [f for f in os.listdir(image_folder) if
                       os.path.isfile(os.path.join(image_folder, f)) and
                       ('left' in f.lower() and 'both' in f.lower())]
...
def function213():  # Blob on left
    ...
    try:
        image_folder = "/home/ratvillage03/academy/stimuli/touchteaching_blob/"
...
def function255():  # When the correct answer is on left
    ...
    image_path = "/home/ratvillage03/academy/stimuli/end_screen.png"
