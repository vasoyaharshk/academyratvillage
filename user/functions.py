...
def function31():  # When the blue jar is on left
    ...
    try:
        ...
        if stage == 1:
            ...
            image_folder = '/home/harsh/academy/stimuli/urn_training/2_discrimination_1'
            left_images = [f for f in os.listdir(image_folder) if
                           os.path.isfile(os.path.join(image_folder, f)) and
                           ('left' in f.lower() and 'both' in f.lower())]
        elif stage == 3:
            image_folder = '/home/harsh/academy/stimuli/urn_training/3_discrimination_2'
            left_images = [f for f in os.listdir(image_folder) if
                           os.path.isfile(os.path.join(image_folder, f)) and
                           ('left' in f.lower() and 'both' in f.lower())]
...
def function61():  # When the correct answer is on left
    ...
    try:
        image_folder = f'/home/harsh/academy/stimuli/webers_law/5_webers_law_training/{trial_condition}'
        left_images = [f for f in os.listdir(image_folder) if
                       os.path.isfile(os.path.join(image_folder, f)) and
                       ('left' in f.lower() and 'both' in f.lower())]
