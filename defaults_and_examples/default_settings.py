...
ARDUINO_SERIAL_PORT = '/dev/ttyUSB-Arduino'                                         # <-- TO CHANGE ttyACM sometimes
...
CAM3_THRESHOLD = 50                                   # <-- TO CHANGE
CAM3_THRESHOLD_MOUSE = 30 #detection for opto         # <-- TO CHANGE
CAM3_THRESHOLD_LED = 100 #detection of the led opto   # <-- TO CHANGE
CAM3_CAGE_ZONE = None
...
TELEGRAM_CHAT = '-480174284'                                                  # <-- TO CHANGE
