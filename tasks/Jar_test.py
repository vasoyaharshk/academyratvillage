...
class Jars_test(Task):
    ...
    def __init__(self):
        ...
        self.info = """
        This task displays the image of the jars only.
        """
    ...
    def main_loop(self):
        ...
        self.sma.add_state(
            ...
            state_change_conditions={Bpod.Events.GlobalTimer1_End: 'Display_off1'},
            output_actions=[(Bpod.OutputChannels.SoftCode, 6), (Bpod.OutputChannels.PWM1, 100)]
        )
        ...
        self.sma.add_state(
            ...
            state_timer=self.time_on,
            state_change_conditions={Bpod.Events.GlobalTimer1_End: 'Display_off2'},
            output_actions=[(Bpod.OutputChannels.SoftCode, 7), (Bpod.OutputChannels.PWM1, 100)]
        )
        ...
        self.sma.add_state(
            ...
            state_timer=self.time_on,
            state_change_conditions={Bpod.Events.GlobalTimer1_End: 'Display_off3'},
            output_actions=[(Bpod.OutputChannels.SoftCode, 9), (Bpod.OutputChannels.PWM1, 100)]
        )
