...
class Probability_Handtracking_Only_Images_FF(Task):
    ...
    def get_stim_image_path(self, stim_trial, stage):
        ...
        try:
            ...
            if stage == 1:
                image_folder = '/home/ratvillage01/academy/stimuli/bastos_taylor/hand_tracking/stage_1_only_Images'
            elif stage == 2:
                image_folder = '/home/ratvillage01/academy/stimuli/bastos_taylor/hand_tracking/stage_2_video/images'
            else:
