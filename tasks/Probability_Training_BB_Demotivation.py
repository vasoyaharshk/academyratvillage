...
class Probability_Training_BB_Demotivation(Task):
    def __init__(self):
        super().__init__()

        self.info = """
        This task displays the image of the jars which are touchable. This script is based on the main script now with side bias breaking. 
        The rat will get 300 ul of water after it enters.
        ########   TASK INFO   ########
