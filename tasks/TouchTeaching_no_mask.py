...
class TouchTeaching_no_mask(Task):
    ...
    def init_variables(self):
        # general
        self.duration_max = 20  # Maximum duration of the task. 50 mins
        self.duration_min = 10  # Minimum duration of the task. 35 mins.
        ...
        self.valve_factor_c = 5.6  # More reward for correct. 2.0 = 50uL
