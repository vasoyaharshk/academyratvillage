...
class StageTraining_8B_V1(Task):
    ...
    def __init__(self):
        ...
        self.info = """
        ########   TASK INFO   ########
        --> Update: trial blocks with same stimulus in stage 1
    ...
    def init_variables(self):
        # general
        self.duration_max = 3000 #2700 #  3000 50 min finished the task
        self.duration_min = 2100 #1500   #  2100 35 min door opens
        self.duration_tired = 1800 #1500 # 1800 30 mins if animal sleeping last 10 mins, finishes task
    ...
    def main_loop(self):
        ...
        if self.current_trial == 0:  # Make a list with x values
            ...
            # 1 choice all the session
                ...
                try:
                    ...
                    p = [0, 1, 0]  # center choice by default
        ...
        # silent trials
        if self.silent == True and self.stage == 3 and self.current_trial > 8:
