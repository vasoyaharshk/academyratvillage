...
class Probability_Extra_Training_Bias_Left_Acc(Task):
    def __init__(self):
        ...
        self.info = """
        This script is IF THE BIAS IS TOWARDS THE RIGHT SIDE.  So the stim will be displayed on the LEFT more than the LEFT.
        ...
        Substage_bias 1: 90% on left and 10% on right.
        Substage_bias 2: 75% on left and 25% on right.
