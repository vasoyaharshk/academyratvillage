...
class StageTraining_RatB_Ciri_Sorrel(Task):
    ...
    def init_variables(self):
        ...
        self.valve_factor_c = 1.6                 #Increased to 2 from 1 on 2024-06-27 due to low motivation by rats. Decreased back to 1 on 28/06/24.
