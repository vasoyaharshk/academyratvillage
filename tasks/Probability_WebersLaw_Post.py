...
class Probability_WebersLaw_Post(Task):
    def __init__(self):
        super().__init__()
        ...
        self.valve_factor_c = 1.5  # Normal water delivery of 25ul multiplied by this
    ...
    def main_loop(self):
        ...
        if self.current_condition in [1, 2]:
            self.stim = [83, 84, 85, 86]  # These are the functions being called. Odds are for the correct answer is on the left and Evens are when the correct answer is on the right
        else:
            self.stim = [81, 82]  # These are the functions being called. 41 is for the correct answer is on the left and 42 is when the correct answer is on the right
        ...
        if self.stage == 4:
            ...
            self.sma.add_state(
                ...
                output_actions=[(Bpod.OutputChannels.PWM1, 5), (Bpod.OutputChannels.SoftCode, 87)])
            ...
            self.sma.add_state(
                ...
                output_actions=[(Bpod.OutputChannels.PWM1, 5), (Bpod.OutputChannels.LED, 6), (Bpod.OutputChannels.SoftCode, 88)])
