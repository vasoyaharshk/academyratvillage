from metapensiero.pj.testing import ast_dump_file
...
class Probability_Extra_Training_Acc_Stage_2(Task):
    def __init__(self):
        super().__init__()
        ...
        if self.task_number == 1:
            if self.stage == 1:
                ...
                self.sma.add_state(
                    ...
                    state_change_conditions={'SoftCode1': 'Correct', 'SoftCode3': 'Punish',
                                             'SoftCode4': 'Punish',
