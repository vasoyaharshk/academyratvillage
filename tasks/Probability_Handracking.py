...
class Probability_Handracking(Task):
    ...
    def get_stim_video_path(self, stim_trial, stage):
        ...
        try:
            ...
            if stage == 2:
                ...
                video_folder = '/home/ratvillage02/academy/stimuli/bastos_taylor/hand_tracking/'
            else:
    ...
    def get_stim_image_path(self, stim_trial):
        ...
        """
        image_path = None
        image_folder = f'/home/ratvillage02/academy/stimuli/bastos_taylor/hand_tracking/stage_2_hand_tracking_video/images'
