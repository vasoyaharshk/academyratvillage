...
class Probability_Test_BT(Task):
    def __init__(self):
        ...
        # ==============================
        # Task specific:
        self.accuracy_criteria = 0.70  # move forward criteria. 80% success on block_size(32/40 trials correct)
        self.trial_end_criteria = 1600  # Move back criteria. Badly named - this is task end criteria.
        ...
        self.consecutive_good_blocks_criteria = 1
