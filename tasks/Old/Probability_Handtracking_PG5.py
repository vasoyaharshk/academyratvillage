...
class Probability_Handtracking_Zoomed_Mod_FF(Task):
    def __init__(self):
        super().__init__()
...
<<<<<<<< HEAD:tasks/Old/Probability_Handtracking_PG5.py
========
            elif stage == 3:
...
>>>>>>>> origin/laptop_rv1:tasks/Probability_Handtracking_Zoomed_Mod_FF.py
            else:
