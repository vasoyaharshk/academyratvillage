...
class Probability_Extra_Training_Bias_Left_Correction(Task):
    def __init__(self):
        ...
        This script has correction allowed which means the animal can correct its mistake.
        This script is for the extra training if rats are struggling to discriminate between stimuli.
        ...
        Substage_bias 3: 50% on left and 50% on right.
        ...
        Note side bias breaking activate for substage_bias = 3
        """
        ...
        self.valve_factor_i = 1.0  # Water delivery for corrections
